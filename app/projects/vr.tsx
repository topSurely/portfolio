...
export const VRProjects: Project[] = [
    {
        ...
        description:
            <div>
                <p>{"An immersive experience telling the story of Thunder (Ksiistsikom) as the player searches for their wife. Players would learn simple words in Blackfoot and narrated by an authentic Blackfoot Elder, Saakokoto."}</p>
            </div>,
        myRole:
            <div>
