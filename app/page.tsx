        ...
        <div className={`${styles.infobox}`} style={{ position: "relative" }}>
          ...
          <div className={`${styles.grid} ${styles.skillGrid}`}>
            ...
            <div className={styles.extra} style={{textAlign:"center"}}>
              ...
              <p style={{paddingTop:"1rem"}}>I'm not an artist by any means, but I have over 15 years of experience with Blender and regularly handle my own exports and asset setup to ensure an asset functions exactly as needed.</p>
            </div>
